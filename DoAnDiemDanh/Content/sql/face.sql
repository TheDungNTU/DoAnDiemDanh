...
CREATE TABLE LOP(
	...
	TenLop VARCHAR(100),
	MaKhoa INT CONSTRAINT FK_LOP_KHOA FOREIGN KEY REFERENCES dbo.KHOA(MaKhoa)
)
GO
...
CREATE TABLE GIANGVIEN(
	...
	TenGV NVARCHAR(200),
	Email VARCHAR(500),
	MaKhoa INT CONSTRAINT FK_GIANGVIEN_KHOA FOREIGN KEY REFERENCES dbo.KHOA(MaKhoa)
)
GO
...
CREATE TABLE TAIKHOAN(
	...
	MaQuyen INT FOREIGN KEY REFERENCES dbo.QUYEN(MaQuyen),
)
GO
...
CREATE TABLE SINHVIEN(
	...
	TenSV NVARCHAR(200),
	MaKhoa INT CONSTRAINT FK_SINHVIEN_KHOA FOREIGN KEY REFERENCES dbo.KHOA(MaKhoa),
...
CREATE TABLE MONHOC(
	...
	ThoiGianBDGD TIME,
	ThoiGianKTGD TIME,
	MaGV INT CONSTRAINT FK_MONHOC_GIANGVIEN FOREIGN KEY REFERENCES dbo.GIANGVIEN(MaGV)
)
GO

CREATE TABLE DIEMDANH(
	MaDD INT IDENTITY(1,1) PRIMARY KEY,
	MaMH INT CONSTRAINT FK_DIEMDANH_MONHOC FOREIGN KEY REFERENCES dbo.MONHOC(MaMH) ON DELETE CASCADE,
	NgayDiemDanh DATE
)
GO
...
CREATE TABLE SINHVIEN_MONHOC(
	MaSV INT CONSTRAINT FK_SINHVIEN_MONHOC_1 FOREIGN KEY REFERENCES dbo.SINHVIEN(MaSV),
...
CREATE TABLE CTDD(
	MaDD INT CONSTRAINT FK_CTDD_DD FOREIGN KEY REFERENCES dbo.DIEMDANH(MaDD) NOT NULL,
...
CREATE TABLE HINHANH(
	...
	TenHA VARCHAR(500),
	BASE64 VARCHAR(MAX),
	MaSV INT CONSTRAINT FK_HINHANH_SINHVIEN FOREIGN KEY REFERENCES dbo.SINHVIEN(MaSV) ON DELETE CASCADE
)
GO

CREATE TABLE DIEMDANH_T(
	MaDD INT IDENTITY(1,1) PRIMARY KEY,
	MaSV INT FOREIGN KEY REFERENCES dbo.SINHVIEN(MaSV) ON DELETE CASCADE,
...
INSERT INTO dbo.QUYEN
        ( TenQuyen, GhiChu )
VALUES  ( 'Admin', N'Đây là tài khoản admin'),
		( 'User', N'Đây là tài khoản user')


INSERT INTO dbo.GIANGVIEN
        ( TenGV, Email, MaKhoa )
VALUES  ( N'Lê Thế Dũng','thedung6332@gmail.com',1)

INSERT INTO dbo.TAIKHOAN
        ( TaiKhoan, MatKhau, MaGV, MaQuyen )
VALUES  ( 'thedung6332@gmail.com', 'admin', 1, 1)
